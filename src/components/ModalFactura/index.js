...
function ModalFactura(Props) {
	...
	const [selectPorcion, setSelectPorcion] = useState('');
	...
	return (
		...
		>
											...
											return (
												<li key={index}>
													<div style={styles.liDiv}>
														...
														<span style={styles.liSpan}>{result.fecha}</span>
														<i
															style={styles.liIcon}
			...
			<DialogActions className="dialogo">
				...
				<Button onClick={() => alert('funciona')} className="ui buttonGuardar" color="primary" autoFocus>
					Agregar
				</Button>
			</DialogActions>
		</Dialog>
